...
Typical URL: **`http://localhost:3030`**. The tool automatically sets `VITE_PUBLIC_DOMAIN` and `VITE_PROTECTED_DOMAIN` to point at the dashboard and mock-oauth-proxy.
